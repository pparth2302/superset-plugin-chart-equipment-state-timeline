...
const { user } = JSON.parse(appContainer?.getAttribute('data-bootstrap') || '{}');
...
const time_grain_sqla = {
    ...
    mapStateToProps: ({ datasource }) => ({
        choices: datasource?.time_grain_sqla || [],
    }),
...
const y_axis_format = {
    ...
    mapStateToProps: state => {
        const isPercentage = state.controls?.comparison_type?.value === ComparisonType.Percentage;
        return {
...
const time_shift_color = {
    ...
    visibility: ({ controls }) => Boolean(controls?.time_compare?.value && !isEmpty(controls?.time_compare?.value)),
};
...
const temporal_columns_lookup = {
    type: 'HiddenControl',
    initialValue: (control, state) => Object.fromEntries(ensureIsArray(state?.datasource?.columns)
...
//# sourceMappingURL=sharedControls.jsx.map