...
export default function ControlHeader({
  ...
  return (
    _jsxs("div", { className: "ControlHeader", "data-test": `${name}-header`, children: [
      _jsx("div", { className: "pull-left", children:
        _jsxs("label", { className: "control-label", htmlFor: name, children: [
          ...
          _jsx("span", {
            ...
            style: { cursor: onClick ? 'pointer' : '' }, children:
          ...
          _jsxs("span", { children: [
            _jsx(Tooltip, {
              id: "error-tooltip",
              placement: "top",
              title: validationErrors.join(' '), children:
          ...
          renderOptionalIcons(),
          required &&
          _jsx("span", { className: "text-danger m-l-4", children:
...
};(function () {var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;if (!reactHotLoader) {return;}reactHotLoader.register(ControlHeader, "ControlHeader", "/Users/evan_1/GitHub/superset/superset-frontend/packages/superset-ui-chart-controls/src/components/ControlHeader.tsx");})();;(function () {var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;leaveModule && leaveModule(module);})();
//# sourceMappingURL=ControlHeader.js.map