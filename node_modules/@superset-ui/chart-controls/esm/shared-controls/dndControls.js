...

{
  ...
  allowAll: true,
  filterOption: ({ data: opt }, text) => {var _opt$column_name, _opt$verbose_name;return (
      ((_opt$column_name = opt.column_name) == null ? void 0 : _opt$column_name.toLowerCase().includes(text.toLowerCase())) || ((_opt$verbose_name =
...
//# sourceMappingURL=dndControls.js.map