import _isEmpty from "lodash/isEmpty"; /* eslint-disable camelcase */
/**
...
const order_desc = {
  ...
  visibility: ({ controls }) =>
  Boolean(
    (controls == null ? void 0 : controls.timeseries_limit_metric.value) &&
...
const y_axis_format =
{
  ...
  mapStateToProps: (state) => {var _state$controls, _state$controls$compa;
    const isPercentage =
    ((_state$controls = state.controls) == null ? void 0 : (_state$controls$compa = _state$controls.comparison_type) == null ? void 0 : _state$controls$compa.value) === ComparisonType.Percentage;
    return {
...
const time_shift_color = {
  ...
  visibility: ({ controls }) => {var _controls$time_compar, _controls$time_compar2;return (
      Boolean(
        (controls == null ? void 0 : (_controls$time_compar = controls.time_compare) == null ? void 0 : _controls$time_compar.value) && !_isEmpty(controls == null ? void 0 : (_controls$time_compar2 = controls.time_compare) == null ? void 0 : _controls$time_compar2.value)
      ));}
};
...
const temporal_columns_lookup = {
  type: 'HiddenControl',
  initialValue: (control, state) => {var _state$datasource;return (
      Object.fromEntries(
        ensureIsArray(state == null ? void 0 : (_state$datasource = state.datasource) == null ? void 0 : _state$datasource.columns).
...
//# sourceMappingURL=sharedControls.js.map