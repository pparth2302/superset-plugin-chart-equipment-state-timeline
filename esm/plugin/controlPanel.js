  ...
  controlPanelSections: [{
    ...
    controlSetRows: [[{
      ...
      config: _extends({}, sharedControls.series, {
        ...
        clearable: true,
        description: t('Optional temporal column used by Superset native time range filters. This usually matches the start time column.')
      })
    ...
    controlSetRows: [[{
      ...
      config: {
        ...
        default: '',
        renderTrigger: true,
        description: t('Optional minimum zoom range in milliseconds to keep very dense timelines readable.')
      }
    }], [{
      ...
      config: {
        ...
        renderTrigger: true,
        description: t('Use JSON or one mapping per line, for example Running Normally = #16a34a.')
      }
    }]]
