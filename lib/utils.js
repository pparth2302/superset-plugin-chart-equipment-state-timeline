...
exports.TOOLTIP_FIELD_DEFINITIONS = exports.DEFAULT_REASON_COLORS = void 0;
exports.buildSegmentId = buildSegmentId;
exports.buildTooltipHtml = buildTooltipHtml;
exports.formatDuration = formatDuration;
exports.formatNumber = formatNumber;
exports.formatPercent = formatPercent;
exports.formatTimestampValue = formatTimestampValue;
exports.formatTooltipValue = formatTooltipValue;
exports.getColumnLabel = getColumnLabel;
exports.normalizeDurationValueToMs = normalizeDurationValueToMs;
exports.parseOptionalNumber = parseOptionalNumber;
exports.parsePositiveInteger = parsePositiveInteger;
exports.parseStateColorMapping = parseStateColorMapping;
exports.parseTimestamp = parseTimestamp;
exports.resolveSegmentColor = resolveSegmentColor;
exports.stringifyValue = stringifyValue;
exports.uniqueColumnLikes = uniqueColumnLikes;
/**
...
var DEFAULT_REASON_COLORS = exports.DEFAULT_REASON_COLORS = {
...
var TOOLTIP_FIELD_DEFINITIONS = exports.TOOLTIP_FIELD_DEFINITIONS = [{
...
function parsePositiveInteger(value, fallback, bounds) {
...
function normalizeDurationValueToMs(value) {
...
function formatTimestampValue(value, formatter) {
...
function formatTooltipValue(tooltipRow, formatter) {
...
function parseStateColorMapping(input) {
...
function resolveSegmentColor(reason, mapping, fallbackColor) {
...
function uniqueColumnLikes(columns) {
  var seen = new Set();
...
function buildSegmentId(index, reason, start, end) {
  return index + ":" + reason + ":" + start + ":" + end;
}
function escapeHtml(value) {
  return value.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#39;');
}
function buildTooltipHtml(segment, formatter) {
