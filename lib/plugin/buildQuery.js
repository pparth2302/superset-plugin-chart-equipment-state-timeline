...
function buildQuery(formData) {
  ...
  var columns = (0, _utils.uniqueColumnLikes)([fd.start_time_column, fd.end_time_column, fd.reason_column, ...tooltipColumns]);
  var rowLimit = (0, _utils.parsePositiveInteger)(fd.row_limit, 10000, {
    min: 1
  });
  var orderby = [(0, _utils.getColumnLabel)(fd.start_time_column), (0, _utils.getColumnLabel)(fd.end_time_column)].filter(value => Boolean(value)).map(label => [label, true]);
