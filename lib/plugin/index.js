 ...
 * under the License.
 */
class EquipmentStateTimelineChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../EquipmentStateTimelineChart'))),
      metadata: _metadata.default,
      transformProps: _transformProps.default
    });
  }
}
exports.default = EquipmentStateTimelineChartPlugin;