...
export type TooltipValueType = 'string' | 'timestamp' | 'duration' | 'number' | 'percent';
export type TooltipControlKey = 'productive_pct_column' | 'not_productive_pct_column' | 'not_scheduled_pct_column' | 'in_count_column' | 'good_count_column' | 'reject_count_column' | 'efficiency_column' | 'oee_column' | 'oee_loss_column' | 'down_duration_column' | 'planned_stop_duration_column' | 'cycle_loss_duration_column' | 'small_stop_duration_column' | 'startup_rejects_column' | 'production_rejects_column';
