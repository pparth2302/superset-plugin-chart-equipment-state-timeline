...
exports.default = EquipmentStateTimelineChart;
...
function EquipmentStateTimelineChart(props) {
  var {
    width,
    height,
    segments,
  ...
  (0, _react.useEffect)(() => {
    ...
    var option = {
      ...
      xAxis: {
        ...
        axisLabel: {
          color: axisTextColor,
          formatter: value => (0, _utils.formatTimestampValue)(value, timeFormatter)
        },
        splitLine: {
          show: false
        }
      ...
      tooltip: tooltipEnabled ? {
        ...
        formatter: params => {
          ...
          return segment ? (0, _utils.buildTooltipHtml)(segment, tooltipTimeFormatter) : '';
        }
      } : {
        show: false
      },
